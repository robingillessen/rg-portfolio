...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "robinlaurentius@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* Show merged skills only for id === 3 */}
          {id === 3 && (
            <div className="flex flex-wrap gap-2 mt-3 z-10">
              {[...leftLists].map((item, i) => (
                <span
                  key={i}
                  className="py-1 px-3 text-xs lg:text-base rounded-lg text-center bg-[#10132E] text-white opacity-80"
                >
                  {item}
                </span>
              ))}
